...
def get_exchange_connection():
    ...
    for ex_info in EXCHANGE_CLASSES:
        try:
            ...
            # SPEED OPTIMIZATION: We do NOT load_markets() here. 
            # We use specific symbols, so we can skip the long loading time.
...
def scanner_loop():
    ...
    while True:
        ...
        try:
            ...
            print(f"Scan OK: {len(results)} symbols | Exchange: {ex_name}")
            time.sleep(45)
